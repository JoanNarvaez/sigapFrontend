...
ngOnInit(): void {
  ...
  if (id){
    ...
    numero_identificacion: [afiliado.numero_identificacion, [Validators.required,Validators.maxLength(16),Validators.pattern(/^[0-9]+$/)]],
    primer_apellido: [afiliado.primer_apellido, [Validators.required,Validators.maxLength(60)]],
    segundo_apellido: [afiliado.segundo_apellido], // No se requiere validator
    primer_nombre: [afiliado.primer_nombre, [Validators.required,Validators.maxLength(60)]],
    segundo_nombre: [afiliado.segundo_nombre], // No se requiere validator
    fecha_nacimiento: [afiliado.fecha_nacimiento, [Validators.required,birthDateValidator()]],
    genero: [afiliado.genero, Validators.required],
    codigo_municipio: [afiliado.codigo_municipio, [Validators.required,Validators.maxLength(5)]],
    indicador: [afiliado.indicador, Validators.required],
    telefono: [afiliado.telefono, [Validators.required,Validators.maxLength(22)]],
    direccion: [afiliado.direccion, [Validators.required,Validators.maxLength(200)]],
    email: [afiliado.email, [Validators.email,Validators.maxLength(101)]],
    // email: [afiliado.email,Validators.email],
    fecha_ingreso: [afiliado.fecha_ingreso, [Validators.required,birthDateValidator()]],
    ...
    this.form = this.fb.group({
        ...
        numero_identificacion: ['', [Validators.required,Validators.maxLength(16),Validators.pattern(/^[0-9]+$/)]],
