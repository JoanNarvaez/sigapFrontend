...
export default class ReservaEspecialComponent implements OnInit {
      ...
      this.reservaEspecialService
        ...
        .subscribe((reservaEspecial) => {
          ...
          this.form = this.fb.group({
            ...
            digito_verificacion: [
              reservaEspecial.digito_verificacion,
              [Validators.maxLength(9), Validators.pattern('^[0-9]*$')],
            ],
            razon_social: [
              reservaEspecial.razon_social,
              [Validators.maxLength(200)],
            ],
            primer_apellido: [
              reservaEspecial.primer_apellido,
              [Validators.required, Validators.maxLength(60)],
            ],
            segundo_apellido: [
              reservaEspecial.segundo_apellido,
              [Validators.maxLength(60)],
            ],
            primer_nombre: [
              reservaEspecial.primer_nombre,
              [Validators.required, Validators.maxLength(60)],
            ],
            segundo_nombre: [
              reservaEspecial.segundo_nombre,
              [Validators.maxLength(60)],
            ],
            tarjeta_profecional: [
              reservaEspecial.tarjeta_profecional,
              [Validators.maxLength(20)],
            ],
            codigo_municipio: [
              reservaEspecial.codigo_municipio,
              [Validators.required, Validators.maxLength(5)],
            ],
            telefono: [
              reservaEspecial.telefono,
              [Validators.required, Validators.maxLength(22)],
            ],
            direccion: [
              reservaEspecial.direccion,
              [Validators.required, Validators.maxLength(200)],
            ],
            email: [
              reservaEspecial.email,
  ...
  save() {
    ...
    if (this.reservaEspecial) {
      this.reservaEspecialService
        .update(this.reservaEspecial.id, reservaEspecialForm)
        .subscribe({
          next: () => {
            this.errors = [];
